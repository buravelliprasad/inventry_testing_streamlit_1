...
user_api_key = st.sidebar.text_input(
    ...
    placeholder="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",
    type="password")
...
embeddings = OpenAIEmbeddings(openai_api_key="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")
